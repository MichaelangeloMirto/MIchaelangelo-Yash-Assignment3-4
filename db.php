...
//database functions
/*This function will be used to display information for the admin users table. 
Only when users log in as an admin will they be able to see all of the content
under posts
*/
...
/*This function will be used to display all information for student posts. This
will only display posts that are by the author students, and not posts by admin
since we do not want them to delete admin posts
*/
function get_article_student($dbconn){
        $query= 
                "SELECT
                articles.created_on as date,
                articles.aid as aid,
